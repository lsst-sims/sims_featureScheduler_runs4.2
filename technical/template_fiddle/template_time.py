...
def gen_scheduler(args):
    ...
    fileroot, extra_info = set_run_info(dbroot=dbroot,
                                        file_end="season%i_v4.2_" % season_length,
                                        out_dir=out_dir)
    ...
    greedy = gen_greedy_surveys(nside, nexp=nexp, footprints=footprints, season=season_length)
...
def sched_argparser():
    ...
    parser.add_argument("--season_length", type=float, default=300)
    parser.add_argument(
        "--mjd_plus",
        type=float,
        default=0,
